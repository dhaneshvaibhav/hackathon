"""add roles column to clubs (retry)

Revision ID: 81ef06bac148
Revises: cc83213db427
Create Date: 2026-02-21 21:31:54.765882
...
revision = '81ef06bac148'
down_revision = 'cc83213db427'
branch_labels = None
depends_on = None
