"""add role column to club_request

Revision ID: cc83213db427
Revises: d1f1a645915a
Create Date: 2026-02-21 21:26:48.226467
...
revision = 'cc83213db427'
down_revision = 'd1f1a645915a'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    # op.drop_table('oauth')
    with op.batch_alter_table('club_requests', schema=None) as batch_op:
